...
- [ ] **Phase 1: General Codebase Audit** - Identify bugs, performance bottlenecks, and security issues.
...
Plans:
- [ ] 01-01: Execute general codebase audit and generate report
...
**Depends on**: Phase 1
**Requirements**: RFACT-01, RFACT-02
**Success Criteria** (what must be TRUE):
...
|-------|----------------|--------|-----------|
| 1. General Codebase Audit | 0/1 | Not started | - |
