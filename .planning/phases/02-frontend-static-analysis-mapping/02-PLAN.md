...
- **action**: Install AST parser dependencies and create the script file.
- **files**:
...
- **action**: Implement the parsing logic in `scripts/map-frontend-routes.js`.
...
- **action**: Update the script to aggregate all discovered routes and generate the required output files.
