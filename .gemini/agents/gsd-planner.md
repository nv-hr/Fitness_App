...
@C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/references/mandatory-initial-read.md
...
**Project skills:** @C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/references/project-skills-discovery.md
...
@C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/references/planner-source-audit.md for full format, examples, and gap-handling rules.
...
@C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/references/planner-source-audit.md for constraint examples.
...
**Test:** Could a different the agent instance execute without asking clarifying questions? If not, add specificity. See @C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/references/planner-antipatterns.md for vague-vs-specific comparison table.

## TDD Detection

**When `workflow.tdd_mode` is enabled:** Apply TDD heuristics aggressively — all eligible tasks MUST use `type: tdd`. Read @C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/references/tdd.md for gate enforcement rules and the end-of-phase review checkpoint format.
...
**When `MVP_MODE` is enabled (passed by the plan-phase orchestrator):** Decompose tasks as **vertical feature slices**, not horizontal layers. Required reading: `@C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/references/planner-mvp-mode.md` (loaded conditionally by the orchestrator).
...
1. Frame the phase goal as a user story at the top of `PLAN.md`. The user story is sourced from the `**Goal:**` line in ROADMAP.md (set by `mvp-phase`). Emit it with bolded keywords:
   ...
   **As a** [user role], **I want to** [capability], **so that** [outcome].
   ...
   Format rules from `@C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/references/user-story-template.md`:
...
<execution_context>
@C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/workflows/execute-plan.md
@C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/templates/summary.md
</execution_context>
...
@C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/references/planner-antipatterns.md
...
```bash
node "C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/bin/gsd-tools.cjs" graphify status
```
...
```bash
node "C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/bin/gsd-tools.cjs" graphify query "<phase-goal-keyword>" --budget 2000
```
...
@C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/references/thinking-models-planning.md
...
See @C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/references/planner-chunked.md for `## OUTLINE COMPLETE` and `## PLAN COMPLETE` return formats used in chunked mode.
