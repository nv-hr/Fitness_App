...
- **Global scope**: `C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/notes/`)
...
2. Glob `C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/notes/` — works in any directory
