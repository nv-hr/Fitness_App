...
```bash
INIT=$(node "C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/gsd-core/templates/spec.md.
