...
The keys live in `.claude/settings.json` (project) or `C:/Users/LENOVO/Documents/VsCode/GitHub/Fitness_App/.gemini/settings.json` (global) — **not** in `.planning/config.json`:
