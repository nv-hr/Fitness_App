    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3 px-4 mt-2 rounded-xl text-sm font-semibold text-[#121212] bg-slate-900 hover:bg-slate-800 active:scale-[0.98] transition-all cursor-pointer shadow-sm disabled:bg-slate-300 disabled:cursor-not-allowed disabled:active:scale-100"
        >
          {isSubmitting ? (
      ...
      <div className="relative my-4 flex py-1 items-center">
        ...
        <span className="flex-shrink mx-4 text-slate-400 text-xs font-medium uppercase tracking-wider">Or Sign Up With</span>
        <div className="flex-grow border-t border-slate-200/60"></div>
      </div>

      {/* Google Sign-Up — uses the same OAuth endpoint as login */}
      <a
