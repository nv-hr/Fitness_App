      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xl sm:text-2xl font-display font-black text-white">
            {totalActiveMinutes} <span className="text-xs sm:text-sm font-sans font-medium text-slate-500">mins</span>
          </p>
        </div>
        ...
        <div className="space-y-1">
          ...
          <p className="text-xl sm:text-2xl font-display font-black text-white">
            {totalCaloriesBurned} <span className="text-xs sm:text-sm font-sans font-medium text-slate-500">kcal</span>
          </p>
        </div>
