...
export default function ActivitySummary({ summary }) {
  ...
  return (
    <div className={`p-6 rounded-2xl border transition-all duration-300 ${cardBg}`}>
      <h4 className="text-xs font-semibold text-slate-400 uppercase tracking-widest border-b border-[#2d2d2d] pb-2 mb-4 flex items-center justify-between">
        <span>Daily Activity Metrics</span>
        <span className="flex items-center gap-1 text-[10px] bg-[#242424] text-slate-400 border border-[#333] px-2 py-0.5 rounded font-mono font-bold">
          LIVE METRICS
        </span>
      </h4>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
        {/* Active Minutes */}
        <div className="bg-[#242424] border border-[#333] p-3.5 rounded-xl space-y-1">
